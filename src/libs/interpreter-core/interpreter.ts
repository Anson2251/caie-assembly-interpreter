...
export const MNEMONIC_DATA_MOVE = {
    ...
    "END": 0x07   // Return control to the operating system
};
...
export const MNEMONIC_COMPARE = {
    ...
    "CMI_ADDRESS":      0x42   // Compare ACC with contents of the contents of the specified address (indirect addressing)
};
